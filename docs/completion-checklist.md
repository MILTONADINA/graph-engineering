...
| 13  | Representative calibration and held-out evidence           | Nine pinned historical intake tasks, five guarded/isolated task verifiers, independent-review tooling, durable collection bookkeeping and full-cohort accounting implemented. Four replay adapters and protected collection/promotion integration remain. **Not complete as evidence:** independent labels, unseen held-out tasks and paired measured model costs/outcomes remain required. |
