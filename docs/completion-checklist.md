...
| 5   | MCP client integration                                     | Cloud-filtered retrieval passed. Claude Code Max and Codex each retrieved selected source through the project MCP. The corrected Cursor project-only stdio configuration completed a direct `template_list` call with 61 catalog entries; its separate in-editor call remains unverified. Serena activation under `GRAPH ENGINEERING` is separate and its shared configuration was untouched.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
